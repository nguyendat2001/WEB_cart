...
session_start();
    ...
    $sql_up = $connect->prepare("SELECT * FROM products where product_id= ?");
    $sql_up->execute([$id]);
    $row_up = $sql_up->get_result()->fetch_assoc();
        ...
        if( isset($_POST["submit"])){
            ...
            $sql = $connect->prepare("UPDATE products SET product_name = '$product_name',image = '$image'
            ,price='$price',quantity='$quantity',description='$description',brand_id='$brand_id' 
            WHERE product_id = ?");
            $sql->execute([$id]);
    ...
    <section class="feature_part section_padding" style="background:rgba(244, 202, 231, 0.2);">
        ...
        <form class="form row justify-content-center" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-lg-8 row justify-content-center">
                <label class="col-lg-4  mt-3">Tên Sản phẩm: </label>
                <input type="text" class="col-lg-8  mt-3" name="product_name" value="<?php echo $row_up['product_name'];?>">
                <label class="col-lg-4  mt-3">Anh san pham: </label>
                <input type="file" class="col-lg-8  mt-3" name="image">
                <label class="col-lg-4  mt-3">Gia san pham: </label>
                <input type="text" class="col-lg-8  mt-3" name="price" value="<?php echo $row_up['price'];?>">
                <label class="col-lg-4  mt-3">So luong san pham: </label>
                <input type="text" class="col-lg-8  mt-3" name="quantity" value="<?php echo $row_up['quantity'];?>">
                <label class="col-lg-4  mt-3">Mo ta: </label>
                <input type="text" class="col-lg-8  mt-3" name="description" value="<?php echo $row_up['description'];?>">
                <label class="col-lg-4 mt-3">loai hang:</label>
